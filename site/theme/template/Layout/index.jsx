...
export default collect(async (nextProps) => {
  ...
  if (path === 'index' || path === '/') {
    ...
    const componentsPageData = nextProps.utils.get(nextProps.data, ['components'])['business'].demo();//basic
    return {
      localizedPageData: {
        exhibition: await exhibitionPageData,
        'business': await componentsPageData,// queue-anim
      },
    };
  }
  ...
  if (pathname === 'components') {
    location.href = '/components/basic';
    return;
  }
