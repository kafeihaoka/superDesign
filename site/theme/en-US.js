module.exports = {
  ...
  messages: {
    ...
    'app.header.menu.language': '起步',
    'app.header.menu.components': '组件',
    'app.header.menu.templates': '动效模板',
    'app.header.lang': 'English',
    'app.home.introduce':
      '使用 super design components 能够快速在 React 框架中构建应用。',
    'app.home.introduce2': '我们提供了基础组件与特定业务组件模块。',
    'app.home.learn-more': '了解更多',
    'app.home.enter-editor': '快速搭建',
    'app.home.page1.title': 'super design 让应用更简单',
    'app.home.page1.content':
      '在 React 框架下，只需要一段简单的代码就可以实现特定业务组件效果，可以更好的提高你的工作效率。',
    'app.home.page2.content':
      '通过 super design ，可以快速的实现不同组合的组件效果。\n 配合不同交互模式，可以直接运用到你的项目当中。',
